    ...
    return (
        <>
            <div className="xl:px-20 px-6 py-20 xl:mx-auto xl:container">
                <h1 className="xl:text-5xl md:text-4xl text-2xl  leading-tight text-center font-black text-[#facc15] sm:mb-0 mb-12">
                ...
                <div className="md:mt-14 mt-4 relative sm:flex items-center justify-center">
                    ...
                    <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-[#facc15] rounded-2xl sm:absolute relative z-20 sm:mt-0 mt-4 left-0 xl:ml-56 sm:ml-12 xl:-mt-40 sm:-mt-12">
                        <p className="text-3xl font-semibold ">20K+</p>
                        <p className="text-base leading-4 xl:mt-4 mt-2 ">Recently Property Listed</p>
                    </div>
                    <div className="shadow-lg xl:p-6 p-4 w-48 sm:w-auto w-full bg-[#facc15] rounded-2xl sm:absolute relative z-20 sm:mt-0 mt-4 xl:mt-80 sm:mt-56 xl:-ml-0 sm:-ml-12">
                        <p className="text-3xl font-semibold ">8K+</p>
                        <p className="text-base leading-4 xl:mt-4 mt-2 ">Active Listening</p>
                    </div>
                    <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-[#facc15] rounded-2xl sm:absolute relative z-20 md:mt-0 sm:-mt-5 mt-4 right-0 xl:mr-56 sm:mr-24">
      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid row-gap-10 mb-8 lg:grid-cols-6">
          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            Enter your email to get the latest books
            </p>
          </div>
        </div>
        <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row">
          <p className="text-sm text-black">
            © Copyright 2022 Fahad All rights reserved.
          </p>
